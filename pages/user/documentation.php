                  ...
                  <div class="card-body">
                    <form>
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="employeeId" placeholder="Masukkan ID Karyawan">
                      </div>
                      <div class="form-group">
                        <label for="employeeOutlet">Outlet</label>
                        <select class="form-control" id="employeeOutlet">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="employeeName" placeholder="Masukkan Nama Karyawan">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="reason" rows="3" placeholder="Masukkan Alasan Cuti"></textarea>
                      </div>
